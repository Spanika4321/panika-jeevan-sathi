      ...
      try {
        ...
        for (const table of Object.keys(TABLES)) {
          try {
            ...
            // Analytics is optional for older installations; all member tables are required.
            if (!['site_stats', 'site_visitors'].includes(table)) throw err;
            log(`[supabase] optional analytics table ${table} is unavailable`);
          }
        }
        loaded = true;
        lastError = null;
