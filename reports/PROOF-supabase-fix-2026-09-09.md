...
Generated: 2026-09-09T06:21:03.413Z
...
| photo upload via API | PASS | MOCK | {"status":200,"photo":"/uploads/u2-1788934862910.png"} | lib/photos.js save → supabase put |
...
| external store has the member (direct sqlite, not via app) | PASS | MOCK | mock.hasUser(ravi.proof.1788934862293@example.com)=true userCount=3 | scripts/lib/mock-supabase.mjs sqlite file |
| external store has the photo object (direct, not via app) | PASS | MOCK | key=u2-1788934862910.png hasObject=true objectsDir=/tmp/pjs-supabase-proof-WxRGTH/external-store/objects | scripts/lib/mock-supabase.mjs objects dir |
| app disk wiped (no local sqlite leftover) | PASS | MOCK | files=[] | /tmp/pjs-supabase-proof-WxRGTH/app-disk |
| external sqlite still has the member after app-disk wipe | PASS | MOCK | hasUser=true userCount=3 store=/tmp/pjs-supabase-proof-WxRGTH/external-store files=objects,supabase.sqlite,supabase.sqlite-shm,supabase.sqlite-wal | /tmp/pjs-supabase-proof-WxRGTH/external-store/supabase.sqlite |
| external object store still has the photo after app-disk wipe | PASS | MOCK | hasObject=true photoFileOnDisk=true objects=u2-1788934862910.png | /tmp/pjs-supabase-proof-WxRGTH/external-store/objects |
| external store survived mock-process restart (disk, not RAM) | PASS | MOCK | hasUser=true hasObject=true url2=http://127.0.0.1:35823 | /tmp/pjs-supabase-proof-WxRGTH/external-store/supabase.sqlite |
| restart health still supabase (empty local disk) | PASS | MOCK | {"storage":"supabase","photos":"supabase+cache"} | server.js after wipe |
| login after wipe+restart | PASS | MOCK | {"status":200,"email":"ravi.proof.1788934862293@example.com"} | lib/api.js POST /api/auth/login |
...
| messages survived wipe+restart | PASS | MOCK | [{"user":{"id":3,"name":"Meera Proof","photo":null,"age":25,"city":"Raipur","state":"","community":"Panika","education":"","occupation":"Teacher","available":true},"last_message":"proof-message-1788934862293","last_at":1788934863042,"last_from_me":true,"unread":0}] | messages table via PostgREST |
| photo bytes survived wipe+restart (fetched from remote store) | PASS | MOCK | http 200 bytes=93 url=/uploads/u2-1788934862910.png | lib/photos.js ensure → supabase get |
| this run used a local PostgREST mock, not supabase.com | PASS | MOCK | SUPABASE_URL=http://127.0.0.1:43799 (loopback mock). Production not exercised. | scripts/prove-supabase-wipe.mjs |

## Paths

- App disk (wiped): `/tmp/pjs-supabase-proof-WxRGTH/app-disk`
- External store: `/tmp/pjs-supabase-proof-WxRGTH/external-store`
- Mock sqlite: `/tmp/pjs-supabase-proof-WxRGTH/external-store/supabase.sqlite`
- Mock objects: `/tmp/pjs-supabase-proof-WxRGTH/external-store/objects`
- Health after first boot: `{"ok":true,"service":"panika-jeevan-sathi","time":1788934862811,"boot_at":1788934862379,"security_revision":"2026-09-05","release":null,"storage":"supabase","photos":"supabase+cache","durable":true,"data_loss_risk":false,"mail":{"configured":false,"delivery_verified":false},"remote":{"database":{"kind":"supabase","loaded":true,"pending":0,"lastError":null,"requests":53},"photos":{"kind":"supabase+cache","remote":true,"pending":0,"uploads":0,"downloads":0,"lastFlushAt":0,"lastError":null}}}`
- Health after wipe+restart: `{"ok":true,"service":"panika-jeevan-sathi","time":1788934863317,"boot_at":1788934863127,"security_revision":"2026-09-05","release":null,"storage":"supabase","photos":"supabase+cache","durable":true,"data_loss_risk":false,"mail":{"configured":false,"delivery_verified":false},"remote":{"database":{"kind":"supabase","loaded":true,"pending":0,"lastError":null,"requests":20},"photos":{"kind":"supabase+cache","remote":true,"pending":0,"uploads":0,"downloads":0,"lastFlushAt":0,"lastError":null}}}`
